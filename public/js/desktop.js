...
const DesktopApp = {
    ...
    applySettings() {
        ...
        // Contact
        if (s.show_contact !== 'false' && (s.contact_phone || s.contact_email || s.contact_address)) {
            ...
            if (s.contact_address) {
                document.getElementById('contact-address').textContent = s.contact_address;
                document.getElementById('contact-address-item').style.display = 'flex';
            }
        }
